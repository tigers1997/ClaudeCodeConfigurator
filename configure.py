...
def main():
    ...
    if is_retrofit:
        ...
        has_discipline = "discipline-skills" in config["selected"]
        if has_discipline:
            print("  1. If this is a brand-new project, brainstorm the design before")
            print("     implementation. The discipline-skills module just installed")
            print("     the brainstorming skill \u2014 invoke it via:")
            print(dim("       claude  # describe what you want to build \u2014 the"))
            print(dim("                 brainstorming skill auto-triggers and hard-gates"))
            ...
            print("     before implementation. The discipline-skills module wasn't installed;")
            print("     to add it, re-run cc-configure and select it, or install the")
            print("     upstream plugin:")
